  ...
  describe('ngceProp*', () => {
    ...
    it('should use the full ngce-prop-* attribute name in $attr mappings', () => {
      ...
      inject(($compile: any, $rootScope: any) => {
        ...
        expect(attrs.$attr.ngcePropMyCamelTitle).toBe('ngce-prop-my-camel_title');
      });
    });
    ...
    it('should disallow property binding to onclick', inject((
      ...
      expect(() => $compile('<button ng-custom-element ngce-prop-onclick="onClickJs"></button>')($rootScope))
        .toThrowError('Property bindings for HTML DOM event properties are disallowed.');
    ...
    it('should process property bindings in pre-linking phase at priority 100', function() {
      angular.mock.module(($compileProvider: any, $provide: any) => {
        ...
        $compileProvider.directive('propLogHighPriority', (log: any, $rootScope: any) => ({
          priority: 101,
          link: {
            pre: (_$scope: any, $element: any) => {
    ...
    it('should clean up watchers when the element is destroyed', inject(($compile: any, $rootScope: any) => {
      var element = $compile('<div><p><span ng-custom-element ngce-prop-test="name"></span></p></div>')($rootScope);
    ...
    ['img', 'audio', 'video'].forEach(function(tag) {
      ...
      if (msie !== 9 || tag === 'img') {
        xdescribe(tag + '[src] context requirement', function() {
          ...
          it('should sanitize non-whitelisted values', inject(function(
            $rootScope: any,
            $compile: any,
            $sce: any
          ) {
          ...
          it('should sanitize wrongly typed values', inject(function(
            $rootScope: any,
            $compile: any,
            $sce: any
          ) {
    ...
    xdescribe('a[href] sanitization', function() {
      it('should NOT require trusted values for whitelisted values', inject(function(
        $rootScope: any,
        $compile: any
      ) {
    ...
    xdescribe('iframe[src]', function() {
      ...
      it('should clear out src properties for a different domain', inject(function(
        $compile: any,
        $rootScope: any,
        $sce: any
      ) {
      ...
      it('should clear out JS src properties', inject(function(
        $compile: any,
        $rootScope: any,
        $sce: any
      ) {
      ...
      it('should clear out non-resource_url src properties', inject(function(
        $compile: any,
        $rootScope: any,
        $sce: any
      ) {
    ...
    xdescribe('base[href]', function() {
      it('should be a RESOURCE_URL context', inject(function(
        $compile: any,
        $rootScope: any,
        $sce: any
      ) {
    ...
    xdescribe('form[action]', function() {
      ...
      it('should clear out action property for a different domain', inject(function(
        $compile: any,
        $rootScope: any,
        $sce: any
      ) {
      ...
      it('should clear out JS action property', inject(function(
        $compile: any,
        $rootScope: any,
        $sce: any
      ) {
      ...
      it('should clear out non-resource_url action property', inject(function(
        $compile: any,
        $rootScope: any,
        $sce: any
      ) {
    ...
    xdescribe('link[href]', function() {
      it('should reject invalid RESOURCE_URLs', inject(function(
        $compile: any,
        $rootScope: any
      ) {
        var element = $compile(
    ...
    xdescribe('*[innerHTML]', function() {
      describe('SCE disabled', function() {
        ...
        it('should one-time bind if the expression starts with two colons', inject(function(
          $rootScope: any,
          $compile: any
        ) {
          var element = $compile(
      ...
      describe('SCE enabled', function() {
        it('should NOT set html for untrusted values', inject(function(
          $rootScope: any,
          $compile: any
        ) {
          var element = $compile(
        ...
        it('should NOT set html for wrongly typed values', inject(function(
          $rootScope: any,
          $compile: any,
          $sce: any
        ) {
    ...
    xdescribe('*[style]', function() {
      ...
      it('should NOT set style for untrusted values', inject(function(
        $rootScope: any,
        $compile: any
      ) {
        var element = $compile(
      ...
      it('should NOT set style for wrongly typed values', inject(function(
        $rootScope: any,
        $compile: any,
        $sce: any
      ) {
